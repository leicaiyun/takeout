    ...
    <div>
        ...
        <div class="body">
            <el-table :data="tableData" style="width: 100%" class="table" border>
                ...
                <el-table-column prop="user_tel" label="订餐人电话" width="150" align="center">
                </el-table-column>
                ...
                <el-table-column prop="dm_tel" label="送餐员电话" width="110" align="center">
                </el-table-column>
            </el-table>
...
export default {
    ...
    methods: {
        getdata() {
            this.$axios.get("/manager/selectAll2_o").then((res) => {
